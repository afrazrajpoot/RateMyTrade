          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`mt-1 p-2 border border-black-on-active border-3 w-full ${errors.name ? 'bg-rose-200' : ''} ${errors.name ? 'border-2 border-red-500' : ''}`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`mt-1 p-2 border border-black-on-active border-3 w-full ${errors.email ? 'bg-rose-200' : ''} ${errors.email ? 'border-2 border-red-500' : ''}`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`mt-1 p-2 border border-black-on-active border-3 w-full ${errors.phone ? 'bg-rose-200' : ''} ${errors.phone ? 'border-2 border-red-500' : ''}`}
            ...
            <div>
              ...
              <input
                ...
                value={formData.date}
                onChange={handleChange}
                className={`mt-1 p-2 border border-black-on-active border-3 w-full ${errors.date ? 'bg-rose-200' : ''} ${errors.date ? 'border-2 border-red-500' : ''}`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`mt-1 p-2 border border-black-on-active border-3 w-full ${errors.startTime ? 'bg-rose-200' : ''} ${errors.startTime ? 'border-2 border-red-500' : ''}`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`mt-1 p-2 border border-black-on-active border-3 w-full ${errors.endTime ? 'bg-rose-200' : ''} ${errors.endTime ? 'border-2 border-red-500' : ''}`}
                placeholder="Enter Time"
              />
            ...
            <div className="col-span-2">
              ...
              <textarea
                ...
                onChange={handleChange}
                className={`mt-1 p-2 border border-black-on-active border-3 w-full block p-2.5 text-sm text-gray-900 bg-gray-50 rounded-lg border-gray-300   ${errors.addInfo ? 'bg-rose-200' : ''}`}
